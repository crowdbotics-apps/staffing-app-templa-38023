...
## Project Structure
    ...
    ├── staffing_app_templa_38023  # Django project configurations
...
1. Clone this repo and `cd staffing_app_templa_38023`
...
2. Clone this repo and `cd staffing_app_templa_38023`
